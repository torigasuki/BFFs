...
class GroupPurchaseViewTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.grouppurchase_data = {
            "community": cls.community.id,
        ...
        cls.grouppurchase_data_open_fail = {
            "community": cls.community.id,
            "category": cls.category.id,
            "user": cls.user.id,
            "title": "puchase create feed3",
        ...
        cls.grouppurchase_data_close_fail = {
            "community": cls.community.id,
            "category": cls.category.id,
            "user": cls.user.id,
            "title": "puchase create feed3",
        ...
        cls.grouppurchase_data_meeting_fail = {
            "community": cls.community.id,
            "category": cls.category.id,
            "user": cls.user.id,
            "title": "puchase create feed3",
        ...
        cls.grouppurchase_data_is_ended = {
            "community": cls.community.id,
            "category": cls.category.id,
            "user": cls.user.id,
            "title": "puchase create feed3",
    ...
    def setUp(self):
        ...
        self.access_token3 = self.client.post(reverse("login"), self.user_data3).data[
            "access"
        ]
