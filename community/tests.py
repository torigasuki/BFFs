...
class CommunityViewTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.user_data2 = {'email': 'test2@naver.com', 'name': 'test2', 'password': 'test123!'}
        ...
        cls.community = Community.objects.create(title = 'title2', introduction = 'introduction2')
    ...
    def setUp(self):
        ...
        self.access_token2 = self.client.post(reverse("login"), self.user_data2).data["access"]
...
class CommunitySubAdminViewTest(APITestCase):
    ...
    def setUpTestData(cls):
        cls.user_data = {'email': 'test1@naver.com', 'name': 'test1', 'password': 'test123!'}
        cls.user_data2 = {'email': 'test2@naver.com', 'name': 'test2', 'password': 'test123!'}
        cls.user_data3 = {'email': 'test3@naver.com', 'name': 'test3', 'password': 'test123!'}
        cls.user_data4 = {'email': 'test4@naver.com', 'name': 'test4', 'password': 'test123!'}
        cls.user_data5 = {'email': 'test5@naver.com', 'name': 'test5', 'password': 'test123!'}
        cls.user = User.objects.create_user('test1@naver.com', 'test1', 'test123!')
        cls.user2 = User.objects.create_user('test2@naver.com', 'test2', 'test123!')
